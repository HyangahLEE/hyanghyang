...
<table width="600" style="margin: 50px auto" border="1">
		...
		<tr>
			...
			<input type="button" value="글수정" onclick="location.href='edit.do?num=${ dto.num }&page=${ param.page}&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">
       ...
       onclick="location.href='Delete.do?num=${ vo.num }&currentPage=${currentPage}'">
        --%> <input type="button" value="답글"
				...
				<input type="button" value="글목록" onclick="location.href='list.do?page=${ param.page}&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
